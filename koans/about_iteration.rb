...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject runs a block against the result of performing a method on the target array, 
    # using an optional parameter in the block along with the array. In the first case, 
    # its summing the array values, then adding the parameter to the sum.
  end
  ...
  # This is to preserve state. All open files need to be closed. By setting the variable 'file' to the contents of file we lose the abilit to close it.
